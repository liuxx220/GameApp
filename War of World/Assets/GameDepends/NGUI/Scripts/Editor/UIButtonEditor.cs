...
public class UIButtonEditor : UIButtonColorEditor
{
	...
	protected override void DrawProperties ()
	{
		...
		// 显示audioclip
		GUILayout.BeginHorizontal ();
		NGUIEditorTools.DrawProperty ("Sound", serializedObject, "clickSound", GUILayout.Width (200f));
		NGUIEditorTools.DrawProperty ("Volumn", serializedObject, "clickSoundVolumn", GUILayout.Width (150.0f));
		GUILayout.EndHorizontal ();

		// 显示自动缩放AutoZoom
		GUILayout.BeginHorizontal ();
		NGUIEditorTools.DrawProperty ("Auto Zoom", serializedObject, "autoZoom", GUILayout.Width (200f));
		//NGUIEditorTools.DrawProperty ("")
		GUILayout.EndHorizontal ();
