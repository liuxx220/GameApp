...
public class UIWidget : UIRect
{
	...
	public void ManualScale (int px)
	{
		if (px == 0) {
			width = defaultWidth;
		...
		int large = defaultWidth > defaultHeight ? defaultWidth : defaultHeight;
		float percent = 1 - px * 1.0f / large;

		width = Mathf.RoundToInt (defaultWidth * percent);
		height = Mathf.RoundToInt (defaultHeight * percent);
	}
}
