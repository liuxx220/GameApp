...
protected:
	UNORDERED_MAP< std::string, SHARED_PTR< SqlStatement > > query_sqlStatements_;
	UNORDERED_MAP< std::string, SHARED_PTR< SqlStatement > > update_sqlStatements_;
	UNORDERED_MAP< std::string, SHARED_PTR< SqlStatement > > insert_sqlStatements_;
};
