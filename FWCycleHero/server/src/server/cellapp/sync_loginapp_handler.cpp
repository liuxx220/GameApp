...
namespace KBEngine{	
	...
	//-------------------------------------------------------------------------------------
	CLoginAppNetCmdMgr::CLoginAppNetCmdMgr()
	{
		m_mapProc.Clear();
	}
	...
	// destroy
	//-----------------------------------------------------------------------------
	void CLoginAppNetCmdMgr::Destroy()
	{
	...
	// 注册消息
	//-----------------------------------------------------------------------------
	bool CLoginAppNetCmdMgr::Register(UINT32 dwID, LOGINNETMSGHANDLER fp, char* szDesc)
	{
	...
	// 取消注册
	//------------------------------------------------------------------------------
	void CLoginAppNetCmdMgr::UnRegisterAll()
	{
	...
	// 得到某个消息ID对应的处理函数
	//------------------------------------------------------------------------------
	LOGINNETMSGHANDLER CLoginAppNetCmdMgr::GetMsgHandler(UINT32 dwMsgID, UINT32 nSize)
	{
