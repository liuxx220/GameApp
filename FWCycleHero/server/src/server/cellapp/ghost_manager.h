...
public:
	...
	void pushMessage(COMPONENT_ID componentID, Bundle* pBundle);
	void pushRouteMessage(ENTITY_ID entityID, COMPONENT_ID componentID, Bundle* pBundle);
...
private:
	...
	// 所有需要广播的事件消息
	std::map<COMPONENT_ID, std::vector< Bundle* > > messages_;
