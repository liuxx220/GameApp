...
//-------------------------------------------------------------------------------------
Cellappmgr::Cellappmgr(EventDispatcher& dispatcher, 
...
//-------------------------------------------------------------------------------------
void Cellappmgr::onChannelDeregister(Channel * pChannel)
{
	// 如果是app死亡了
...
void Cellappmgr::handleGameTick()
{
	...
	NetSession().processChannels(&CellappmgrInterface::messageHandlers);*/
}
...
//-------------------------------------------------------------------------------------
void Cellappmgr::forwardMessage(Channel* pChannel, MemoryStream& s)
{
...
//-------------------------------------------------------------------------------------
void Cellappmgr::reqCreateInNewSpace(Channel* pChannel, MemoryStream& s) 
{
...
//-------------------------------------------------------------------------------------
void Cellappmgr::reqRestoreSpaceInCell(Channel* pChannel, MemoryStream& s) 
{
	/*std::string entityType;
	ENTITY_ID id;
	COMPONENT_ID componentID;
...
//-------------------------------------------------------------------------------------
void Cellappmgr::updateCellapp(Channel* pChannel, COMPONENT_ID componentID, 
...
//-------------------------------------------------------------------------------------
void Cellappmgr::onCellappInitProgress(Channel* pChannel, COMPONENT_ID cid, float progress)
{
	/*if(progress > 1.f)
	{
