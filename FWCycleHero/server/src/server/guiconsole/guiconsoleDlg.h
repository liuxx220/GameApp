...
class CguiconsoleDlg : public CDialog
					//	public ChannelTimeOutHandler,
					//	public ChannelDeregisterHandler
{
// Construction
public:
...
public:
	/** 服务器执行指令完毕回显 */
	void onExecScriptCommandCB(Channel* pChannel, std::string& command);
	...
	EventDispatcher & mainDispatcher()				{ return _dispatcher; }
	NetSession & NetSession()			{ return _NetSession; }
	...
	Address getTreeItemAddr(HTREEITEM hItem);
