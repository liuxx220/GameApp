...
namespace LuaFramework
{
    public class Util {
        ...
        public static string GetKey(string key) {
            return ClientAppArgs.AppPrefix + ClientAppArgs.UserId + "_" + key;
        }
        ...
        public static string DataPath {
            get {
                string game = ClientAppArgs.AppName.ToLower();
        ...
        {
            string path = ClientAppArgs.DebugMode ? Application.dataPath + "/" : DataPath;
        ...
        public static object[] CallMethod(string module, string func, params object[] args) {
            LuaScriptMgr luaMgr = ClientApp.Instance.GetManager<LuaScriptMgr>(ManagerName.Lua);
        ...
        public static bool CheckEnvironment() {
            ...
            if (Application.loadedLevelName == "Test" && !ClientAppArgs.DebugMode)
            {
