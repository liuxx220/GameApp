...
public class GameObjectWrap
{
	...
	static int get_rigidbody(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Rigidbody>());
		return 1;
	}
	...
	static int get_rigidbody2D(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Rigidbody2D>());
		return 1;
	}
	...
	static int get_camera(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Camera>());
		return 1;
	}
	...
	static int get_light(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Light>());
		return 1;
	}
	...
	static int get_animation(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Animation>());
		return 1;
	}
	...
	static int get_constantForce(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<ConstantForce>());
		return 1;
	}
	...
	static int get_renderer(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Renderer>());
		return 1;
	}
	...
	static int get_audio(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<AudioSource>());
		return 1;
	}
	...
	static int get_guiText(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<GUIText>());
		return 1;
	}
	...
	static int get_networkView(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<NetworkView>());
		return 1;
	}
	...
	static int get_guiTexture(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<GUITexture>());
		return 1;
	}
	...
	static int get_collider(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Collider>());
		return 1;
	}
	...
	static int get_collider2D(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<Collider2D>());
		return 1;
	}
	...
	static int get_hingeJoint(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<HingeJoint>());
		return 1;
	}
	...
	static int get_particleEmitter(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<ParticleEmitter>());
		return 1;
	}
	...
	static int get_particleSystem(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.GetComponent<ParticleSystem>());
		return 1;
	}
	...
	static int AddComponent(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(GameObject), typeof(string)))
		{
			GameObject obj = (GameObject)LuaScriptMgr.GetUnityObjectSelf(L, 1, "GameObject");
			string arg0 = LuaScriptMgr.GetString(L, 2);
			Component o = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(obj, "Assets/GameScript/GameLib/Model2Lua/LuaWrapModel/GameObjectWrap.cs (1097,18)", arg0);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else
