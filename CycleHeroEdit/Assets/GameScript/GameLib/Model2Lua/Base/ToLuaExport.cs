...
public static class ToLuaExport 
{
    ...
    public static void Generate(params string[] param)
    {
        ...
        if (type.IsEnum)
        {
            ...
            GenEnumTranslator();
            sb.AppendLine("}\r\n");
            SaveFile(ClientAppArgs.LuaWrapPath + wrapClassName + "Wrap.cs");
            return;
        }
        ...
        string path = ClientAppArgs.LuaWrapPath;
    ...
    {        
        ...
        sb.AppendLine("}");
        SaveFile(ClientAppArgs.LuaBasePath + "Base/DelegateFactory.cs");
