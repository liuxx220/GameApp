...
public class CHLGEffectComponent : MonoBehaviour
{
    ...
    public int _downsampleFactor = 0;
    ...
    private int layerMask = (1 << CHLGObjectComponent.highlightingLayer);
    ...
    private static Material compMaterial
    {
        get
        {
            if( _compMaterial == null )
            {
                ...
                _compShader.hideFlags = HideFlags.HideAndDontSave;
            }
