...
public class Framework_TimerManagerWrap
{
    ...
    //    LuaScriptMgr.RegisterLib(L, "Framework.TimerManager", typeof(SimpleFramework.Manager.TimerManager), regs, fields, typeof(View));
    }
